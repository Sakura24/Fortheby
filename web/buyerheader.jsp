<%-- 
    Document   : buyerheader
    Created on : 26-Apr-2019, 18:48:34
    Author     : Bishnu
--%>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                <li><a href="buyerprofile.jsp"><i class="fa fa-user" aria-hidden="true"> Profile</i></a></li>
                                <li><a href="buyeritem.jsp"><i class="fa fa-picture-o" aria-hidden="true"> Items</i></a></li>
                                <li><a href="boughtitem.jsp"><i class="fa fa-money" aria-hidden="true"> Bought Item</i></a></li>
                                <li><a href="biditem.jsp"><i class="fa fa-gavel" aria-hidden="true"> Bid Item</i></a></li>
                                <li><a href="buyercontact.jsp"><i class="fa fa-phone" aria-hidden="true"> Contact</i></a></li>
                            </ul>
                        </div>
                        <div class="col-sm-6">
                            <ul class="nav navbar-nav navbar-right">
                            ...
                            <form class="navbar-form navbar-right search-form" action="buyersearch.jsp">
                                <%  try {
                                        searchItem.first();
