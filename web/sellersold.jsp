<%-- 
    Document   : sellersold
    Created on : 26-Apr-2019, 18:21:25
    Author     : Bishnu
--%>
...
<% 
    ...
    ResultSet result = profile.SellerSoldItem(usrEmail);
    int count = profile.CountSellerSoldItem(usrEmail);
%>
            ...
            <form class="form-type list-type">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <a href="sellerreadmore.jsp?&itemId=<%=result.getString(1)%>&catId=<%= result.getString(2)%>" class="read-more link"><b><i><u>read more</u></i></b></a>
                    </div>
                </div>
            </form>
