<%-- 
    Document   : buyerreadmore
    Created on : 27-Apr-2019, 23:08:42
    Author     : Bishnu
--%>
            ...
            <form class="form-type list-type">
                <div class="row">
                    ...
                    <div class="col-md-6 second-column">
                        ...
                        <br>
                        <br>
                        <a href="bidding.jsp?&itemId=<%=itemId%>" class="btn btn-dark add-button" role="button">Bid</a>
                    </div>
                </div>
                    ...
                    <div class="container-fluid cat">
                        <div class="tab-content">
                            <form class="form-type list-type">
                                <div class="row">
                                    <div class="button">
                                        <a href="bidding.jsp?&itemId=<%=itemId%>" class="btn btn-default display-btn bid " role="button">Bid</a>
                                    </div>
                                    <div class="col-md-6 item-column">
                                    ...
                                    <div class="col-md-6 second-column">
                                        ...
                                        <br>
                                        <br>
                                        <a href="bidding.jsp?&itemId=<%=itemId%>" class="btn btn-danger add-button" role="button">Bid</a>
                                    </div>
                                    <% }%>
                                </div>
                            </form>
