<%-- 
    Document   : adminsoldreadmore
    Created on : 26-Apr-2019, 10:56:18
    Author     : Bishnu
--%>
...
<% 
    if (intStatus == 0){
        ...
        result.first(); 
        String comm = item.DisplayCommission(itemId); 
        int intComm = Integer.parseInt(comm);
        String sold = item.AdminSellingPrice(itemId); 
        int soldPrice = Integer.parseInt(sold);
%>
              ...
              <form class="form-type list-type">
                <div class="row">
                    ...
                    <div class="col-md-6 second-column">
                        ...
                        <br>
                        <label>Selling Price: <%=result.getString(9)%></label>
                        <br>
                        <label>Sold Price: <%=soldPrice%></label>
                        <br>
                        <label>Commission: <%=intComm%></label>
                        <br>
