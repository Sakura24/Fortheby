<%-- 
    Document   : categories
    Created on : 08-Apr-2019, 21:42:21
    Author     : Bishnu
--%>
...
<%  DbSelect item = new DbSelect();
    ...
    ResultSet result = item.DisplayItemByStatusCatId(catId);
            ...
            <form class="form-type list-type">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <a href="guestreadmore.jsp?&itemId=<%=result.getString(1)%>&catId=<%= result.getString(2)%>" class="read-more"><b><i><u>read more</u></i></b></a>
                    </div>
                </div>
            </form>
            <%
