        ...
        try {
            ...
            while (collect.hasNext()) {
                ...
                if (item.isFormField()) {
                    ...
                    File file = new File("C:\\Users\\Bishnu\\Documents\\NetBeansProjects\\Fortheby\\web\\upload\\" + fileName);
                    //filePath = file.toString();
                    //out.print("filePath= " + filePath);
                    item.write(file);
                }
            }
            pstm = con.prepareStatement("INSERT INTO items (cat_id, item_name, artist_name, created_year, classify, description, auction_date, price, image, medium, framed, dimension, image_type, material, weight) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
